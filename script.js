...
// Passing Joke to VoiceRSS API
 function tellMe(joke) {
    VoiceRSS.speech({
        key:'5b377fcfde0f4b5981364a818bf5a41a',
        src: joke,
        hl:'en-us',
        r: 0,
        c:'mp3',
...
async function getJokes(){
    let joke = '';
    const apiUrl = 'https://v2.jokeapi.dev/joke/Programming?blacklistFlags=nsfw,religious,racist,sexist,explicit&type=single';
    try {
